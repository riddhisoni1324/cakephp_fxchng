                ...
                <div class="form-group" id="usage_container">
                 ...
                 <div class="form-group">
                    ...
                    <div style="background:#efefef; width:200px; height:200px;">
                        <?php
                            //echo $this->Html->image('noimage.jpg', array('alt'=>'No Image'));
                        ?>
                    </div>
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        <?php
                            echo $this->form->input('name', array( 'class' => 'required form-control', 'div' => false, 'label' => false, 'id' => 'name', 'value' => $fb_name, 'required'));
                        ?>
                    </div>
                    <div class="clear"></div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        <?php
                            echo $this->form->input('mobile', array( 'class' => 'required form-control number', 'div' => false, 'label' => false, 'id' => 'mobile', 'maxlength' => 10, 'value' => $fb_mobile, 'required', 'type' => 'tel', 'pattern' => '[0-9]{10,10}'));
                        ?>
                    </div>
                    <div class="clear"></div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9">
                        <?php
                            echo $this->form->input('email', array( 'class' => 'required form-control email', 'div' => false, 'label' => false, 'id' => 'email', 'value' => $fb_email, 'required'));
                        ?>
                    </div>
                    <div class="clear"></div>
                </div>
