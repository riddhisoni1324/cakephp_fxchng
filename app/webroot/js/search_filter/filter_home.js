$(document).ready(function() {
    ...
    function get_filter_results() {
        ...
        var get_filter_data = baseUrl+"home/get_category_filter_data/"+current_id+'/'+used+'/'+new_condition+'/'+from_date+'/'+to_date+'/'+left_individual+'/'+left_dealer+'/'+left_minvalue+'/'+left_maxvalue+'/'+main_search;
        $.ajax({
            type: "POST",
            url: get_filter_data,
