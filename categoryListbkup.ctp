	 			...
	 			<div class="">
		 			<div class="hmcntinright2">
		    			<div class="proimg">	    				
		    					...
		    					?>		    															
									<?php echo $this->Html->image($PHOTO_PATH.$item['doc']['primary_photo']['dir'].'/sm_'.$item['doc']['primary_photo']['filename'], array('alt' => 'No Image', 'url'=>array('controller'=>'', 'action' => '')));?>								
	    						<?php
								}
								else { 
